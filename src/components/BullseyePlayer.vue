...
<template>
  <div class="player-root">
    <div class="player-panel bullseye-player" :class="{ 'is-revealed': isRevealed }">
        <!-- Header Scores -->
...
/* Override action-area for Bullseye fixed height */
.bullseye-player .action-area { height: 240px; justify-content: flex-start; }
...
.song-change-enter-from { opacity: 0; transform: translateY(10px); filter: blur(5px); }
.song-change-leave-to { opacity: 0; transform: translateY(-10px); filter: blur(5px); }

.label-reveal-enter-active,
.label-reveal-leave-active { transition: all 0.3s ease; }
.label-reveal-enter-from,
.label-reveal-leave-to { opacity: 0; transform: scale(0.8); }
</style>
