...
import { Music, ArrowLeft, ArrowRight, CheckCircle, XCircle, Calendar, Flame } from 'lucide-vue-next';

const props = defineProps(['pivotYear', 'mysterySong', 'streak', 'feedback', 'isPlaying', 'correctAnswer']);
    ...
    <div class="cards-container single-card">
        ...
        <div class="card mystery-card">
            <div class="card-cover" :class="{ 'spinning': isPlaying }">
                ...
                <div v-if="feedback" class="year-badge" :class="feedback === 'correct' ? 'success' : 'error'">
                    {{ mysterySong.year }}
                </div>
            </div>
...
.year-badge.success { background: #22c55e; }
.year-badge.error { background: #ef4444; }
