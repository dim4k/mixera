...
<template>
  <div class="player-root">
    <div class="player-panel blindtest-player" :class="{ 'is-revealed': isRevealed }">
        ...
        <div class="player-content-inner">
            ...
            <div class="action-area">
                ...
                <!-- Guess Input -->
                <div class="guess-controls" :class="{ 
...
.blindtest-player { overflow: hidden; } /* Clip settings panel animation */
...
.title-wrapper { min-height: 4rem; }
.artist-wrapper { min-height: 2rem; }

.track-title.found { color: #4ade80; }
.track-artist.found { color: #4ade80; }

.mystery-title { font-size: 2rem; color: rgba(255,255,255,0.3); letter-spacing: 0.5rem; margin: 0; }
.mystery-artist { opacity: 0.4; letter-spacing: 0.3rem; }
...
.timer-bar.timer-hidden { opacity: 0; }
.timer-fill { 
    height: 100%; 
...
/* Feedback States */
.input-wrapper.success input { border-color: #22c55e; box-shadow: 0 0 15px rgba(34, 197, 94, 0.5); }
.input-wrapper.warning input { border-color: #f59e0b; box-shadow: 0 0 15px rgba(245, 158, 11, 0.5); }
.input-wrapper.error input { border-color: #ef4444; box-shadow: 0 0 15px rgba(239, 68, 68, 0.5); }
...
.btn-submit:disabled { opacity: 0.5; cursor: not-allowed; filter: grayscale(0.5); transform: none; }

/* Shake/Nudge Animations */
.shake { animation: shake 0.5s cubic-bezier(.36,.07,.19,.97) both; }
.nudge { animation: nudge 0.3s ease-out both; }
@keyframes nudge { 0%, 100% { transform: scale(1); } 50% { transform: scale(1.02); } }
@keyframes shake {
...
.panel-header h3 { margin: 0; font-size: 1.2rem; font-weight: 700; color: #fff; }
.close-btn { background: transparent; border: none; color: rgba(255,255,255,0.6); padding: 4px; }
.panel-content { padding: 1.5rem; display: flex; flex-direction: column; gap: 1.5rem; overflow-y: auto; }
.setting-group { display: flex; flex-direction: column; align-items: flex-start; gap: 0.8rem; width: 100%; }
.setting-group label { font-size: 0.9rem; color: var(--color-primary); font-weight: 700; text-transform: uppercase; }
...
.toggle-btn.active { background: var(--color-primary); color: #000; }

.genre-chips { display: flex; flex-wrap: wrap; gap: 8px; width: 100%; }
.genre-chip {
    background: rgba(255,255,255,0.05);
    border: 1px solid rgba(255,255,255,0.1);
...
.genre-chip.active { background: var(--color-primary); color: #000; border-color: var(--color-primary); }

/* Transitions */
.fade-enter-active, .fade-leave-active { transition: opacity 0.3s ease; }
.fade-enter-from, .fade-leave-to { opacity: 0; }

.label-reveal-enter-active, .label-reveal-leave-active { transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); }
.label-reveal-enter-from { opacity: 0; transform: scale(0.5); }
.label-reveal-leave-to { opacity: 0; transform: scale(1.5); }
